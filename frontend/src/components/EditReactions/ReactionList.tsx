...
interface ReactionListProps {
  ...
  onEdit: (reaction: EditReactionData) => void;
  onDelete: (reactionId: string, reactionName: string) => void;
  isDeleting: boolean;
  isAdmin: boolean;
}
          ...
          <div className="flex items-start justify-between">
            ...
            {isAdmin && (
              <div className="flex items-center space-x-2 ml-4">
                ...
                <button
                  onClick={() => onDelete(reaction.id.toString(), reaction.name)}
                  disabled={isDeleting}
