  ...
  return (
    <div className="group bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 hover:transform hover:scale-105 cursor-pointer">
      ...
      <div className="flex justify-between items-start mb-4">
        <span className="inline-block bg-gray-200 text-gray-900 text-xs font-medium px-3 py-1 rounded-full">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <span
            className="text-sm text-gray-900 text-center font-medium"
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
        ...
        <div className="flex-1 flex items-center justify-center mx-4">
          <svg className="w-8 h-8 text-gray-600 group-hover:text-gray-900 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {tags.length > 0 ? (
            tags.slice(0, 3).map((tag, index) => (
              <span
                key={index}
                className="text-xs bg-gray-200 text-gray-900 px-2 py-1 rounded-md font-medium"
                style={{ fontFamily: 'Inter, sans-serif' }}
              >
                {tag}
              </span>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <button
          className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900 py-2 px-4 rounded-lg text-sm font-semibold transition-colors duration-200 border border-gray-300 hover:border-gray-400"
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
