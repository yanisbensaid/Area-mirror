...
export default function HomePage() {
  ...
  // Get top automations (sorted by popularity)
  ...
  return (
    <main className="pt-16 md:pt-20 min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center space-y-6 md:space-y-8 max-w-4xl mx-auto">
          <div className="space-y-4 md:space-y-6">
            <h1
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold text-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-16">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700 hover:border-purple-500 transition-all duration-200">
          ...
          <div className="mt-12 md:mt-16 pt-8 md:pt-12 border-t border-slate-700">
            <h3
              className="text-xl md:text-2xl font-medium text-white text-center mb-6 md:mb-8"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
              Available Services
            </h3>
            <div className="relative">
              ...
              {canScrollLeft && (
                <button
                  onClick={scrollLeft}
                  aria-label="Scroll left to see previous services"
                  className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-slate-800 rounded-full shadow-lg border border-slate-700 p-2 hover:bg-slate-700 transition-colors duration-200"
              ...
              {canScrollRight && (
                <button
                  onClick={scrollRight}
                  aria-label="Scroll right to see more services"
                  className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-slate-800 rounded-full shadow-lg border border-slate-700 p-2 hover:bg-slate-700 transition-colors duration-200"
                ...
                <div className="flex gap-4 md:gap-6 min-w-max px-2">
                  {loading ? (
                    ...
                    Array.from({ length: 8 }).map((_, index) => (
                      <div key={index} className="flex flex-col items-center p-3 md:p-4 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700 min-w-[100px] md:min-w-[120px]">
                        <div className="w-8 h-8 md:w-12 md:h-12 mb-2 md:mb-3 bg-slate-700 rounded animate-pulse"></div>
                    ...
                    services.map((service) => (
                      <Link
                        ...
                        className="group flex flex-col items-center p-3 md:p-4 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700 hover:border-purple-500 transition-all duration-200 cursor-pointer min-w-[100px] md:min-w-[120px] flex-shrink-0"
                      >
                        <div className="w-8 h-8 md:w-12 md:h-12 mb-2 md:mb-3 transition-transform duration-200 group-hover:scale-110">
                          <img
                            src={`/logo/${service.name}.png?v=3`}
                        ...
                        <span
                          className="text-xs md:text-sm font-medium text-slate-300 group-hover:text-white transition-colors duration-200 text-center"
                          style={{ fontFamily: 'Inter, sans-serif' }}
                        >
                          {service.name}
                        </span>
              ...
              {!loading && services.length > 3 && !canScrollLeft && !canScrollRight && (
                <div className="flex justify-center mt-4 md:hidden">
                  <div className="flex items-center text-xs text-slate-400 bg-slate-800/50 backdrop-blur-sm px-3 py-1 rounded-full border border-slate-700">
          ...
          <div className="flex justify-center mt-8 md:mt-12">
            <div className="animate-bounce">
              <svg
                className="w-6 h-6 md:w-8 md:h-8 text-purple-400 hover:text-purple-300 transition-colors duration-200"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
      ...
      <div id="automation-examples" className="py-12 md:py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h2
              className="text-2xl md:text-3xl lg:text-4xl font-semibold text-white mb-3 md:mb-4"
              style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.2' }}
            >
              Popular Automations
            </h2>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-lg bg-slate-700/50 border border-slate-600 flex items-center justify-center mb-2">
                        <img
                          src={`/logo/${automation.trigger_service.name}.png?v=3`}
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-lg bg-slate-700/50 border border-slate-600 flex items-center justify-center mb-2">
                        <img
                          src={`/logo/${automation.action_service.name}.png?v=3`}
          ...
          <div className="text-center mt-8 md:mt-12">
            <Link
              to="/explore"
              className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-500 transition-colors duration-200 font-medium"
              style={{ fontFamily: 'Inter, sans-serif' }}
              aria-label="Explore all automation templates"
            >
