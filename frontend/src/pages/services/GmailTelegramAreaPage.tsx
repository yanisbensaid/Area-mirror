    ...
    return (
      <main className="pt-16 md:pt-20 px-4 min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="max-w-4xl mx-auto py-12 text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Gmail to Telegram</h1>
                    ...
                    <div className="bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div>
                          ...
                          <p className={`font-bold ${userArea.active ? 'text-green-400' : 'text-slate-500'}`}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
